...
<div class="container-fluid">
	...
	<div class="flex">
		<div class="w-50">
			<p>Enrollment ID <b><?php echo $ef_no ?></b></p>
			<p>Name<b><?php echo ucwords($sname) ?></b></p>
			<p>Course/Semester><b><?php echo $class ?></b></p>
		</div>
		<?php if($_GET['pid'] > 0): ?>
		<div class="w-50">
			<p>Comments<b><?php echo isset($pay_arr[$_GET['pid']]) ? $pay_arr[$_GET['pid']]['remarks']: '' ?></b></p>
